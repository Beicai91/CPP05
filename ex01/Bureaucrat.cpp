...
void    Bureaucrat::signForm(Form &form) const
{
    ...
    catch (const std::exception &e)
    {
        ...
        std::cout << "Bureaucrat activity notification: " << this->_name << " couldn't sign " << form.getName() << " because he or she doesn't have a grade high enough to sign the form" << std::endl; 
    }
}
...
{
    return ("Grade too low:\n If you are creating a bureaucrat, it should be no lower than 150\n If you want a bureaucrat to sign a form, it should be higher than form's grade");
}